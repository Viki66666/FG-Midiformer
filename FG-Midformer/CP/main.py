...
def main():
    ...
    #midi_former_kan = MidiFormerWithKAN(formerConfig=configuration, e2w=e2w, w2e=w2e, use_fif=args.use_fif)
    ...
    #trainer = FormerTrainer(midi_former_kan, train_loader, valid_loader, args.lr, args.batch_size, args.max_seq_len,
                            args.mask_percent, args.cpu, args.use_mlm, args.use_clm, args.cuda_devices)
