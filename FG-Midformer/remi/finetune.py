...
def main():
    ...
    trainer = FinetuneTrainer(midi_former, train_loader, valid_loader, test_loader, index_layer, args.lr,
                              args.class_num,
                              args.hs, y_test.shape, args.cpu, args.cuda_devices, None, seq_class, mode=args.mode)

    # Add learning rate scheduler
    optimizer = torch.optim.Adam(midi_former.parameters(), lr=args.lr)
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=3, gamma=0.95)  # StepLR scheduler example
